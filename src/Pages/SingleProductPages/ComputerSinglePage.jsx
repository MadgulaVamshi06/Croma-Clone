    ...
    <div className="bg-black ">
      ...
      <div className="flex flex-col lg:flex-row mx-auto  max-w-2xl px-4 pb-16 pt-10 sm:px-6">
        ...
        <div className="w-full lg:w-1/2 px-4">
          <h1 className="text-2xl font-bold tracking-tight text-white sm:text-3xl mb-4">{product.company} - {product.model}</h1>

          <h1 className="text-2xl font-bold tracking-tight text-white sm:text-3xl mb-4">
            {product.product}
          </h1>

          <p className="text-base text-white mt-6">{product.description}</p><br />
